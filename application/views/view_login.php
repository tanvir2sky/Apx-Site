...
<html lang="en">
<head>
    <title>APX | Admin</title><meta charset="UTF-8" />
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>uisrc/css/matrix-login.css" />
    <link href="<?php echo base_url(); ?>uisrc/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,700,800' rel='stylesheet' type='text/css'>
</head>
<body>
    <div id="loginbox">  
        <form id="loginform" class="form-vertical" action="<?php echo base_url(); ?>signin" method="post">
         <div class="control-group normal_text"> <h3><img src="<?php echo base_url(); ?>uisrc/img/logo.gif" alt="Logo"  width="174" height="24"/></h3></div>
        ...
        <?php if($this->session->flashdata('message')){echo $this->session->flashdata('message');}else {echo '&nbsp;';} ?>
...
<script src="<?php echo base_url(); ?>uisrc/js/matrix.login.js"></script> 
</body>
</html>
