    ...
    <div class="row-fluid">
      ...
      if(is_array(validation_errors_array())){
        ...
        <div class="widget-box">
         <form method="post" action="<?php echo base_url(); ?>delete-zone-countries-f">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5><?php if(isset($title)){echo $title;} ?></h5>
            <span class="pull-right"><a href="<?php echo base_url(); ?>list-zones-f/<?php if(isset($list_id) && $list_id!=""){echo $list_id;} ?>">
            <button type="button" class="btn btn-info pull-right" style="margin:5px;">Go Back</button></a></span>
            <span class="pull-right"><a href="<?php echo base_url(); ?>add-zone-countries-f/<?php if(isset($zone)){ echo $zone;}else{ echo $this->uri->segment(2);} ?>"><button type="button" class="btn btn-primary" style="margin:5px;">Add New</button></a></span>
              ...
              if(isset($zone_countries_data) && !empty($zone_countries_data)){ 
                ...
                <tr class="gradeX">
                 <td><input type="checkbox" name="zones[]" value="<?php echo $value['zc_id'] ?>" /></td>
                  ...
                  <td class="center"><a title="Trash" href="javascript:confirmDelete('<?php echo base_url(); ?>delete-zone-country-f/<?php echo $value['zc_id']; ?>','Delete')"><i class="icon-trash"></i> Delete</a>
                  </td>
                </tr>
                <?php }}?>
              </tbody>
