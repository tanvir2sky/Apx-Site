        ...
        <div class="row-fluid">
                ...
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                        ...
                        if(access_control_apx('ship_manage','Excel')==true){?>
                            ...
                            <button class="btn btn-info pull-right" onclick="window.location.href='<?php echo base_url();?>upload-shipments'" type="button" style="margin:5px;"><i class="icon-download-alt"></i> Upload shipment</button>
                        <?php }
            ...
            ?>
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <table  class="table table-bordered  with-check" id="admin_table">
                            <thead>
                            <tr>
