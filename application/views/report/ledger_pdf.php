    ...
    <table class="table table-bordered">
        ...
        if (isset($pdf_data) && !empty($pdf_data)) {
            ...
            foreach ($pdf_data as $value) {
                ...
                $crd=$crd+$value["shipPaid"];
                $dbt=$dbt+$value['shipBalance'];
                $pcs=$pcs+$value['shipPcs'];
                $weight=$weight+$value['shipWeight'];
                ?>
                <tr>
                    <td>
                        <?php
            ...
            echo '<tr class="alert-info"><td colspan="8">&nbsp;</td><td>Total Amounts</td><td>' . $weight . '</td><td>' . $pcs . '</td><td>' . $dbt . '</td><td>' . $count . '</td><td>' . $blnc . '</td></tr>';
        }
        ?>
        </tbody>
    </table>
