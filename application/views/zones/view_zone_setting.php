      ...
      <?php if($this->session->flashdata('message')){ echo $this->session->flashdata('message');} ?>
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            ...
            <span class="pull-right"><a href="<?php echo base_url(); ?>add-zone/<?php if(isset($list_id) && $list_id!=""){echo $list_id;} ?>"><button class="btn btn-primary" style="margin:5px;">Add New</button></a></span>
              ...
              if(isset($zone_data) && !empty($zone_data)){ 
                ...
                <tr class="gradeX">
                 <td><input type="checkbox" /></td>
                  ...
                  <td><a href="<?php echo base_url(); ?>zone-countries/<?php echo $value['zone_id']; ?>"><span class="label label-sm label-success">Countries (<?php  echo $value['total_countries']; ?>)</span></a></td>
                  <td><a href="<?php echo base_url(); ?>zone-weight-prices/<?php echo $value['zone_id']; ?>"><span class="label label-sm label-success">View List (<?php  echo $value['total_wp']; ?>)</span></a></td>
                  ...
                  <td class="center"><a title="Edit" href="<?php echo base_url(); ?>edit-zone/<?php echo $value['zone_id']; ?>"><i class="icon-edit"></i> Edit</a>&nbsp;&nbsp;<a title="Trash" href="javascript:confirmDelete('<?php echo base_url(); ?>delete-zone/<?php echo $value['zone_id']; ?>','Delete')"><i class="icon-trash"></i> Delete</a>
                  </td>
                </tr>
                <?php }}?>
              </tbody>
