      ...
      <?php 
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>add-weight-price-action-f" name="basic_validate" id="basic_validate" novalidate="novalidate">
              <div class="control-group">
                <label class="control-label">Weight from</label>
                <div class="controls">
                  <input type="text" class="span8" name="weight_from" value="<?php echo set_value('weight_from'); ?>" placeholder="1">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Weight to</label>
                <div class="controls">
                  <input type="text" class="span8" name="weight_to" value="<?php echo set_value('weight_to'); ?>" placeholder="500">
                </div>
              </div>
               <div class="control-group">
                <label class="control-label">Price</label>
                <div class="controls">
                  <input type="text" class="span8" name="price" value="<?php echo set_value('price'); ?>" placeholder="500.00">
                </div>
              </div>
              ...
              <input type="hidden" name="znid" value="<?php if(isset($_POST['add'])){ echo set_value('znid');}else{ echo $zone_id;} ?>">
                ...
                <span class="pull-right"><a href="<?php echo base_url(); ?>zone-weight-prices-f/<?php echo $zone_id; ?>">
