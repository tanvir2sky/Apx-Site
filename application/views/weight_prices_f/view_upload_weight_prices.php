      ...
      <?php 
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding span6">
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>upload-wp-action-f" name="basic_validate" id="basic_validate" novalidate="novalidate">
