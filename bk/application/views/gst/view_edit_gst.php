        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
           <?php if(isset($no_data)){
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>add-gst-action" name="basic_validate" id="basic_validate" novalidate="novalidate">
            <div class="control-group">
                <label class="control-label">Date From</label>
                <div class="controls">
                  <input type="text" class="datepicker" name="from" value="<?php if(isset($_POST['update'])){ echo set_value('from');}else{ echo $edit_view->from_date;} ?>">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Date To</label>
                <div class="controls">
                  <input type="text" class="datepicker" name="to" value="<?php if(isset($_POST['update'])){ echo set_value('to');}else{ echo $edit_view->to_date;} ?>">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">GST %</label>
                <div class="controls">
                  <input type="text" name="percentage" value="<?php if(isset($_POST['update'])){ echo set_value('percentage');}else{ echo $edit_view->gst_percentage;} ?>" required>
                </div>
              </div>
              <div class="form-actions">
              <input type="hidden" name="gid" value="<?php if(isset($_POST['update'])){ echo set_value('gid');}else{ echo $edit_view->gst_id;} ?>">
