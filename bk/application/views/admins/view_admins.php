              ...
              if(isset($admins_data) && !empty($admins_data)){ 
                ...
                <tr class="gradeX">
                 <td><input type="checkbox" /></td>
                  ...
                  <td><?php if($status!='Error'){ ?><a title="<?php echo $action; ?>" href="javascript:confirmDelete('<?php echo base_url(); ?>change-status/<?php echo $value['id']; ?>','<?php echo $action; ?>')"><?php echo '<span class="label label-sm label-'.$statusclass.'">'.$status.'</span>'; ?></a><?php }else{ echo '<span class="label label-sm label-'.$statusclass.'">'.$status.'</span>'; }?></td></td>
                  <td class="center"><a title="Edit" href="<?php echo base_url(); ?>edit-app-user/<?php echo $value['id']; ?>"><i class="icon-edit"></i> Edit</a>&nbsp;&nbsp;<a title="Trash" href="javascript:confirmDelete('<?php echo base_url(); ?>trash-app-user/<?php echo $value['id']; ?>','Trash')"><i class="icon-trash"></i> Trash</a>&nbsp;&nbsp;
