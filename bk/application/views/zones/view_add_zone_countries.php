      ...
      <?php 
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>add-zone-countries-action" name="basic_validate" id="basic_validate" novalidate="novalidate">
              ...
              <div class="form-actions">
               <input type="hidden" name="znid" value="<?php if(isset($_POST['add'])){ echo set_value('znid');}else{ echo $zone;} ?>">
                ...
                <span class="pull-right"><a href="<?php echo base_url(); ?>zone-countries/<?php echo $zone; ?>">
