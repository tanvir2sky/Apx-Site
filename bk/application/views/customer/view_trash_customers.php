        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table  class="table table-bordered data-table with-check">
              ...
              <tbody>
              <?php 
              if(isset($trashed_customers_data) && !empty($trashed_customers_data)){ 
                $count=1;
                foreach ($trashed_customers_data as $key => $value) {
                  switch($value['status']){
                    case -1:
                        $status='Trashed';
                        $statusclass='danger';
                ...
                <tr class="gradeX">
                 <td><input type="checkbox" /></td>
                  ...
                  <td class="center"><a title="Delete" href="javascript:confirmDelete('<?php echo base_url(); ?>delete-customer/<?php echo 
                  $value['customer_id']; ?>','Delete')"><i class="icon-trash"></i> Delete</a>
                  </td>
                </tr>
                <?php }}?>
              </tbody>
