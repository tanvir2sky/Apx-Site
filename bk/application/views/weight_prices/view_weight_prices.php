      ...
      <?php if($this->session->flashdata('message')){ echo $this->session->flashdata('message');} ?>
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            ...
            <span class="pull-right"><a href="<?php echo base_url(); ?>add-weight-price/<?php if(isset($zone_id)){echo $zone_id;} ?>"><button class="btn btn-primary" style="margin:5px;">Add New</button></a></span>
            <span class="pull-right"><a href="<?php echo base_url(); ?>list-zones/<?php if(isset($list_id)){echo $list_id; }?>">
              ...
              if(isset($wp_data) && !empty($wp_data)){ 
                ...
                <tr class="gradeX">
                 <td><input type="checkbox" /></td>
                  ...
                  <td><?php  echo $value['weight_from']; ?> &nbsp;grams</td>
                  <td><?php  echo $value['weight_to']; ?> &nbsp;grams</td>
                  ...
                  <td class="center"><a title="Edit" href="<?php echo base_url(); ?>edit-weight-price/<?php echo $value['wp_id']; ?>"><i class="icon-edit"></i> Edit</a>&nbsp;&nbsp;<a title="Trash" href="javascript:confirmDelete('<?php echo base_url(); ?>delete-weight-price/<?php echo $value['wp_id']; ?>','Delete')"><i class="icon-trash"></i> Delete</a>
                  </td>
                </tr>
                <?php }}?>
              </tbody>
