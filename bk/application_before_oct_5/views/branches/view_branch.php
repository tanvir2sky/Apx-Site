        ...
        <div class="widget-box">
          ...
          <?php if(isset($no_data)){
            ...
            <div class="span12">
              ...
              <tr><td width="20%">Code</td><td width="80%"><?php echo $detail_view->code; ?></td></tr>
              <tr><td>Branch Name </td><td><?php echo $detail_view->name; ?></td></tr>
              <tr><td>Manager Name </td><td><?php echo $detail_view->manager; ?></td></tr>
              <tr><td>Branch Contact 1 </td><td><?php echo $detail_view->contactNu1; ?></td></tr>
              <tr><td>Branch Contact 2 </td><td><?php echo $detail_view->contactNu2; ?></td></tr>
              <tr><td>Branch Contact 3 </td><td><?php echo $detail_view->contactNu3; ?></td></tr>
              <tr><td>Manager Contact </td><td><?php echo $detail_view->mangerContactNu; ?></td></tr>
